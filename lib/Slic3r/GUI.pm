...
sub OnInit {
    ...
    Slic3r::debugf ("wxWidgets version %s, Wx version %s\n", &Wx::wxVERSION_STRING, $Wx::VERSION); #DIY to pass eclipse verification - peng
    ...
    Slic3r::debugf ("Data directory: %s\n", $datadir); #DIY to pass eclipse verification - peng
...
sub check_version {
    ...
    Slic3r::debugf ("Checking for updates...\n"); #DIY to pass eclipse verification - peng
